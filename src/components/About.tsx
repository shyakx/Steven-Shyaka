      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl text-center hover:shadow-lg hover:shadow-blue-500/25 transition-shadow duration-200 border border-blue-200">
              <Code className="w-12 h-12 text-blue-600 mx-auto mb-4" />
              <h3 className="font-semibold text-gray-800 mb-2">Full-Stack Development</h3>
              <p className="text-sm text-gray-600">React, Flutter, Python, JavaScript</p>
            </div>

            <div className="bg-white p-6 rounded-xl text-center hover:shadow-lg hover:shadow-blue-500/25 transition-shadow duration-200 border border-blue-200">
              <Brain className="w-12 h-12 text-blue-600 mx-auto mb-4" />
              <h3 className="font-semibold text-gray-800 mb-2">Machine Learning</h3>
              <p className="text-sm text-gray-600">Python, Data Analysis, AI Solutions</p>
            </div>

            <div className="bg-white p-6 rounded-xl text-center hover:shadow-lg hover:shadow-blue-500/25 transition-shadow duration-200 border border-blue-200">
              <Database className="w-12 h-12 text-blue-600 mx-auto mb-4" />
              <h3 className="font-semibold text-gray-800 mb-2">Data & Analytics</h3>
              <p className="text-sm text-gray-600">SQL, SPSS, R, Data Visualization</p>
            </div>

            <div className="bg-white p-6 rounded-xl text-center hover:shadow-lg hover:shadow-blue-500/25 transition-shadow duration-200 border border-blue-200">
              <Users className="w-12 h-12 text-blue-600 mx-auto mb-4" />
              <h3 className="font-semibold text-gray-800 mb-2">Business Strategy</h3>
              <p className="text-sm text-gray-600">Product Ownership, Customer Retention</p>
            </div>
          </div>
        </div>
      </div>
